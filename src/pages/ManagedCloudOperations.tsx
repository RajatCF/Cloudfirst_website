  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="w-full bg-[#042f2e] relative overflow-hidden pt-16 lg:pt-20">
        <div className="absolute inset-0 opacity-40" style={{ background: "radial-gradient(ellipse at 75% 30%, hsl(var(--bright-blue)) 0%, transparent 55%), radial-gradient(ellipse at 15% 80%, hsl(var(--light-blue)) 0%, transparent 50%)" }} />
          ...
          <div className="flex flex-col lg:flex-row items-start gap-12">
            <div className="flex-1">
              <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-5" style={{ fontFamily: "'Georgia', serif" }}>
                ...
                <span className="text-light-blue">without the overhead</span>
              </h1>
              ...
              <button onClick={() => navigate("/contact")} className="px-7 py-3 bg-bright-blue hover:bg-bright-blue/90 text-white text-sm font-bold rounded-lg transition-colors">Explore managed ops →</button>
            </div>
            <div className="flex-1 grid grid-cols-2 gap-3">
              {[
                ...
                <div key={s.l} className="bg-white/5 border border-white/10 rounded-xl p-5">
                  <div className="text-2xl font-bold text-light-blue mb-1" style={{ fontFamily: "'Georgia', serif" }}>{s.v}</div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {operationsAreas.map((area) => (
            <div key={area.title} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:border-bright-blue/25 hover:shadow-md transition-all">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.n} className="flex gap-4 p-4 bg-gray-50 rounded-xl">
                  <div className="w-7 h-7 rounded-full bg-bright-blue text-white text-xs font-bold flex items-center justify-center flex-shrink-0">{item.n}</div>
                  <div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="bg-[#042f2e] rounded-2xl px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
          <div className="absolute inset-0 opacity-40" style={{ background: "radial-gradient(ellipse at 90% 50%, hsl(var(--bright-blue)) 0%, transparent 60%)" }} />
          ...
          <div className="relative z-10 flex flex-col gap-3 flex-shrink-0">
            <button onClick={() => navigate("/contact")} className="px-7 py-3 bg-bright-blue hover:bg-bright-blue/90 text-white text-sm font-bold rounded-lg transition-colors whitespace-nowrap">Talk to our ops team →</button>
