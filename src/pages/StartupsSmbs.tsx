    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative overflow-hidden pt-16 lg:pt-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24">
          <span className="inline-block text-xs font-semibold uppercase tracking-widest text-light-blue border border-bright-blue/30 bg-bright-blue/10 rounded-full px-3 py-1 mb-5">By Industry</span>
          <div className="flex flex-col lg:flex-row items-start gap-10">
            <div className="flex-1 max-w-xl">
              <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-5" style={{ fontFamily: "'Georgia', serif" }}>
                Cloud for startups & SMBs —<br /><span className="text-light-blue">move fast, stay lean</span>
              </h1>
              ...
              <button onClick={() => navigate("/contact")} className="px-7 py-3 bg-bright-blue hover:bg-bright-blue/90 text-white text-sm font-bold rounded-lg transition-colors">Get cloud-ready →</button>
            </div>
            <div className="flex-1 grid grid-cols-2 gap-3">
              {[
                ...
                <div key={s.l} className="bg-white/10 border border-white/20 rounded-xl p-4 backdrop-blur-sm">
                  <div className="text-sm font-bold text-light-blue mb-1" style={{ fontFamily: "'Georgia', serif" }}>{s.v}</div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            <div key={item.title} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:border-bright-blue/25 hover:shadow-md transition-all">
      ...
      {/* Growth journey */}
      <div className="bg-gradient-to-br from-bright-blue/10 to-white border-y border-bright-blue/15 py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            {[
              { stage: "Pre-seed / MVP", desc: "Cloud foundation, CI/CD pipeline, basic monitoring, startup credits", badge: "bg-bright-blue/10 text-bright-blue" },
              { stage: "Seed / Growth", desc: "Production hardening, security baseline, cost governance, auto-scaling", badge: "bg-bright-blue/10 text-bright-blue" },
              { stage: "Series A+", desc: "Multi-region, DR, compliance readiness, team onboarding & runbooks", badge: "bg-bright-blue/10 text-bright-blue" },
              { stage: "Scale-up", desc: "Managed operations, FinOps programme, enterprise governance", badge: "bg-bright-blue/10 text-bright-blue" },
            ].map((phase, i) => (
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-bright-blue to-light-blue rounded-2xl px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col gap-3 flex-shrink-0">
            <button onClick={() => navigate("/contact")} className="px-7 py-3 bg-white hover:bg-white/95 text-bright-blue text-sm font-bold rounded-lg transition-colors whitespace-nowrap">Book a free cloud review →</button>
