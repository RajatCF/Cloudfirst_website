...
const partners = [
  { name: "Amazon Web Services", tier: "Premier Partner", logo: "/logo/our partner/Screenshot 2026-05-08 181447.png", color: "border-[#FF9900]/30 bg-[#FF9900]/5", tierColor: "text-[#b36a00] bg-[#FF9900]/10", desc: "CloudFirst is an AWS Premier Consulting Partner — the highest tier — with specialisms in migration, DevOps, and Well-Architected Framework reviews." },
  { name: "Google Cloud", tier: "Premier Partner", logo: "/logo/our partner/Screenshot 2026-05-08 181457.png", color: "border-blue-200 bg-blue-50/50", tierColor: "text-blue-700 bg-blue-50", desc: "Google Cloud Premier Partner with specialisms across Google Workspace, GCP Infrastructure, and Data & AI." },
  { name: "Microsoft Azure", tier: "Solutions Partner", logo: "/logo/our partner/Screenshot 2026-05-08 181519.png", color: "border-[#00a4ef]/30 bg-[#00a4ef]/5", tierColor: "text-[#006ba6] bg-[#00a4ef]/10", desc: "Microsoft Solutions Partner for Infrastructure and Digital & App Innovation with Azure Expert MSP designation." },
  { name: "Veeam", tier: "Technology Partner", logo: "/logo/our partner/Screenshot 2026-05-08 181533.png", color: "border-emerald-200 bg-emerald-50/50", tierColor: "text-emerald-700 bg-emerald-50", desc: "Veeam technology partner — helping customers improve backup resilience, recovery readiness, and ransomware protection across hybrid environments." },
  { name: "Datadog", tier: "Technology Partner", logo: "/logo/our partner/Screenshot 2026-05-08 181541.png", color: "border-violet-200 bg-violet-50/50", tierColor: "text-violet-700 bg-violet-50", desc: "Datadog partner for observability — deploying full-stack monitoring, APM, and security signals for CloudFirst customers." },
  { name: "Zoho", tier: "Technology Partner", logo: "/logo/our partner/Screenshot 2026-05-08 181609.png", color: "border-sky-200 bg-sky-50/50", tierColor: "text-sky-700 bg-sky-50", desc: "Zoho technology partner — supporting CRM and business app enablement with secure integrations, automation, and operational best practices." },
];
